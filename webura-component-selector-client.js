(() => {
  ...
  function isLikelyAppInteractiveTarget(target) {
  ...
  function onClick(e) {
    ...
    // EVERY click — including clicks on buttons/links/inputs — so the element is
    // SELECTED instead of triggering the app's own onClick handler.
